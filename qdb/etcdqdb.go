...
func NewEtcdQDB(addr string) (*EtcdQDB, error) {
	...
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "NewEtcdQDB, %s %#v", addr, cli)
...
func (q *EtcdQDB) DropShardingRule(ctx context.Context, id string) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "drop sharding rule %v", id)
...
func (q *EtcdQDB) DropShardingRuleAll(ctx context.Context) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "drop all sharding rules")
...
func (q *EtcdQDB) GetShardingRule(ctx context.Context, id string) (*ShardingRule, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "get sharding rule %v", id)
...
func (q *EtcdQDB) ListShardingRules(ctx context.Context) ([]*ShardingRule, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "list sharding rules")
...
func (q *EtcdQDB) AddKeyRange(ctx context.Context, keyRange *KeyRange) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "add key range %+v", keyRange)
...
func (q *EtcdQDB) GetKeyRange(ctx context.Context, id string) (*KeyRange, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "get key range %+v", id)
...
func (q *EtcdQDB) UpdateKeyRange(ctx context.Context, keyRange *KeyRange) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "update key range %+v", keyRange)
	rawKeyRange, err := json.Marshal(keyRange)
...
func (q *EtcdQDB) DropKeyRangeAll(ctx context.Context) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "drop all key ranges")
...
func (q *EtcdQDB) DropKeyRange(ctx context.Context, id string) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "drop key range %+v", id)
...
func (q *EtcdQDB) ListKeyRanges(ctx context.Context) ([]*KeyRange, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "list all key ranges")
...
func (q *EtcdQDB) LockKeyRange(ctx context.Context, id string) (*KeyRange, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "lock key range %+v", id)
	q.mu.Lock()
	defer q.mu.Unlock()
...
func (q *EtcdQDB) UnlockKeyRange(ctx context.Context, id string) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "unlock key range %+v", id)
	q.mu.Lock()
	defer q.mu.Unlock()
...
func (q *EtcdQDB) CheckLockedKeyRange(ctx context.Context, id string) (*KeyRange, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "check locked key range %+v", id)
	// implement or remove me
	return nil, nil
}

func (q *EtcdQDB) ShareKeyRange(id string) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "share key range %+v", id)
	// implement or remove me
	return nil
}
...
func (q *EtcdQDB) AddRouter(ctx context.Context, r *Router) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "add router %v", r)
...
func (q *EtcdQDB) DeleteRouter(ctx context.Context, id string) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "delete router %v", id)
...
func (q *EtcdQDB) ListRouters(ctx context.Context) ([]*Router, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "list routers")
...
<<<<<<< Updated upstream:qdb/etcdqdb/etcdqdb.go
...
func (q *EtcdQDB) LockRouter(ctx context.Context, id string) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "lock router %v", id)
>>>>>>> Stashed changes:qdb/etcdqdb.go
	return nil
}
...
func (q *EtcdQDB) AddShard(ctx context.Context, shard *Shard) error {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "add shard %+v", shard)
...
func (q *EtcdQDB) ListShards(ctx context.Context) ([]*Shard, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "list shards")
...
func (q *EtcdQDB) GetShard(ctx context.Context, id string) (*Shard, error) {
	spqrlog.Logger.Printf(spqrlog.DEBUG1, "get shard %v", id)

...
func AddKeyRangeWithChecks(ctx context.Context, qdb qdb.QDB, keyRange *kr.KeyRange) error {
	...
	for _, v := range existsKrids {
		if kr.CmpRangesLess(keyRange.LowerBound, v.LowerBound) && kr.CmpRangesLess(v.LowerBound, keyRange.UpperBound) && !kr.CmpRangesEqual(v.LowerBound, keyRange.UpperBound) ||
			kr.CmpRangesLess(keyRange.LowerBound, v.UpperBound) && kr.CmpRangesLess(v.UpperBound, keyRange.UpperBound) && !kr.CmpRangesEqual(keyRange.LowerBound, v.UpperBound) {

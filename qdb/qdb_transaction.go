...
func NewQdbStatement(cmdType int, key string, value string) (*QdbStatement, error) {
...
func NewQdbStatementExt(cmdType int, key string, value string, extension string) (*QdbStatement, error) {

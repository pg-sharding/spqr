// Code generated by goyacc -o src/yacc/spqrparser/sql.go -p yy src/yacc/spqrparser/sql.y. DO NOT EDIT.

//line src/yacc/spqrparser/sql.y:3

package spqrparser

import __yyfmt__ "fmt"

//line src/yacc/spqrparser/sql.y:4

import (
	"strconv"
)

//line src/yacc/spqrparser/sql.y:15
...
//line src/yacc/spqrparser/sql.y:179
...
//line src/yacc/spqrparser/sql.y:76
		{
			setParseTree(yylex, yyDollar[1].sh_col)
		}
	case 2:
		yyDollar = yyS[yypt-2 : yypt+1]
//line src/yacc/spqrparser/sql.y:80
		{
			setParseTree(yylex, yyDollar[1].kr)
		}
	case 3:
		yyDollar = yyS[yypt-2 : yypt+1]
//line src/yacc/spqrparser/sql.y:84
		{
			setParseTree(yylex, yyDollar[1].show)
		}
	case 4:
		yyDollar = yyS[yypt-2 : yypt+1]
//line src/yacc/spqrparser/sql.y:88
		{
			setParseTree(yylex, yyDollar[1].kill)
		}
	case 5:
		yyDollar = yyS[yypt-0 : yypt+1]
//line src/yacc/spqrparser/sql.y:94
		{
		}
	case 6:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:95
		{
		}
	case 12:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:107
		{
	...
	case 13:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:118
		{
			switch v := string(yyDollar[1].str); v {
			case KillClientsStr:
				yyVAL.str = v
	...
	case 14:
		yyDollar = yyS[yypt-2 : yypt+1]
//line src/yacc/spqrparser/sql.y:130
		{
			yyVAL.show = &Show{Cmd: yyDollar[2].str}
		}
	case 15:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:137
		{
			yyVAL.str = string(yyDollar[1].str)
		}
	case 16:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:143
		{
			yyVAL.int, _ = strconv.Atoi(string(yyDollar[1].str))
		}
	case 17:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:149
		{
			yyVAL.int, _ = strconv.Atoi(string(yyDollar[1].str))
		}
	case 18:
		yyDollar = yyS[yypt-1 : yypt+1]
//line src/yacc/spqrparser/sql.y:155
		{
			yyVAL.int, _ = strconv.Atoi(string(yyDollar[1].str))
		}
	case 19:
		yyDollar = yyS[yypt-4 : yypt+1]
//line src/yacc/spqrparser/sql.y:162
		{
			yyVAL.sh_col = &ShardingColumn{ColName: yyDollar[4].str}
		}
	case 20:
		yyDollar = yyS[yypt-6 : yypt+1]
//line src/yacc/spqrparser/sql.y:169
		{
			yyVAL.kr = &KeyRange{From: yyDollar[4].int, To: yyDollar[5].int, ShardID: yyDollar[6].int}
		}
	case 21:
		yyDollar = yyS[yypt-2 : yypt+1]
//line src/yacc/spqrparser/sql.y:175
		{

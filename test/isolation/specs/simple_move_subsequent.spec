...
session s2
step s2_redistribute_sh3     { select __spqr__console_execute('REDISTRIBUTE KEY RANGE k0 TO sh3') /*__spqr__preferred_engine: v2 */; }
...
# ok
permutation s1_report s1_ev2 s1_i s1_i s1_i s1_spqr_ctid 
            
            s2_redistribute_sh2 s1_spqr_ctid
            s2_redistribute_sh3 s1_spqr_ctid 
            s2_redistribute_sh1 s1_spqr_ctid 

...
ALTER DISTRIBUTION ds1 ATTACH RELATION xxmixed COLUMNS id;
...
CREATE SHARDING RULE t2 COLUMNS id FOR DISTRIBUTION ds2;
...
ALTER DISTRIBUTION ds2 ATTACH RELATION xxmixeduuid COLUMNS id;

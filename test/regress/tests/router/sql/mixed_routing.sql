...
CREATE SHARDING RULE t1 COLUMNS id;
CREATE KEY RANGE krid1 FROM 00000000-0000-0000-0000-000000000000 ROUTE TO sh1;
CREATE KEY RANGE krid2 FROM 88888888-8888-8888-8888-888888888888 ROUTE TO sh2;

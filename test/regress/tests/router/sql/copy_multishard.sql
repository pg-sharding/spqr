...
-- the set of all unsigned 64-bit integers (0 to 9223372036854775807)
ALTER DISTRIBUTION ds1 ATTACH RELATION xx DISTRIBUTION KEY i HASH FUNCTION MURMUR;

-- TEST
\c regress
CREATE TABLE xx (i bigint, j bigint);
...
INSERT INTO xx (i, j) VALUES(9223372036854775808,9223372036854775808);

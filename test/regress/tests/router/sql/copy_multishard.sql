...
SELECT FROM xx WHERE i = 2;
SELECT FROM xx WHERE i = 3;
SELECT FROM xx WHERE i = 4;
SELECT FROM xx WHERE i = 5;
SELECT FROM xx WHERE i = 4294967296;
SELECT FROM xx WHERE i = 4294967297;
SELECT FROM xx WHERE i = 72057594037927936;
SELECT FROM xx WHERE i = 72057594037927937;
SELECT FROM xx WHERE i = 144115188075855872;
SELECT FROM xx WHERE i = 144115188075855871;
SELECT FROM xx WHERE i = 9223372036854775807;
SELECT FROM xx WHERE i = 9223372036854775806;

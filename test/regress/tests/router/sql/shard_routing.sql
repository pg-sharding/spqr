...
CREATE SHARDING RULE r2 COLUMNS id FOR DISTRIBUTION ds1;
...
ALTER DISTRIBUTION ds1 ATTACH RELATION xxerr COLUMNS id;
ALTER DISTRIBUTION ds1 ATTACH RELATION xxtt1 COLUMNS w_id, id;

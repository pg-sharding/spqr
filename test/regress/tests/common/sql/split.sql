...
CREATE DISTRIBUTION ds3 COLUMN TYPES UUID HASH;

CREATE KEY RANGE krid8 FROM 0 ROUTE TO sh1 FOR DISTRIBUTION ds3;

SPLIT KEY RANGE krid9 FROM krid8 BY 10;

SPLIT KEY RANGE krid10 FROM krid9 BY 1073741623;

SHOW key_ranges WHERE distribution_id = 'ds3' ORDER BY lower_bound;

...
ALTER DISTRIBUTION ds1 ALTER RELATION a RENAME DISTRIBUTION KEY another TO renamed_col;
SHOW relations;

ALTER DISTRIBUTION ds1 ALTER RELATION a RENAME DISTRIBUTION KEY nonexistent TO fail_col;

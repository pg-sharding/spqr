...
ALTER REFERENCE TABLE zz2 STORAGE TO (sh1, sh3, sh4);
...
ALTER REFERENCE TABLE zz2 STORAGE TO (sh3);
...
CREATE REFERENCE RELATION zzx;
SHOW reference_relations;
DROP REFERENCE RELATION zz;
DROP REFERENCE RELATION zzx;

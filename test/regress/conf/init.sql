...
CREATE KEY RANGE krid4 FROM 00000000-0000-0000-0000-000000000000 ROUTE TO sh1 FOR DISTRIBUTION ds2;
CREATE KEY RANGE krid5 FROM 80000000-0000-0000-0000-000000000001 ROUTE TO sh2 FOR DISTRIBUTION ds2;
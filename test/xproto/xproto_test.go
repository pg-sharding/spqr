	...
	for gr, msgroup := range []MessageGroup{
...

		{
			Request: []pgproto3.FrontendMessage{
				...
				&pgproto3.Close{
					Name:       "p-zz1",
					ObjectType: 'Z', // this type is malformed
				},
				&pgproto3.Sync{},
			},
			Response: []pgproto3.BackendMessage{
...
func TestDeallocateRemovesPstmts(t *testing.T) {
	...
	tt := []MessageGroup{
		/* by DEALLOCATE ALL simple query */
		{
			Request: []pgproto3.FrontendMessage{
				&pgproto3.Parse{
					Name:  "pstmt",
		...
		/* by DEALLOCATE pstmt simple query */
		{
			Request: []pgproto3.FrontendMessage{
				&pgproto3.Parse{
					Name:  "pstmt",
	...
	tt := []MessageGroup{
		...
		/* by DEALLOCATE pstmt simple query */
		{
			Request: []pgproto3.FrontendMessage{
				...
				&pgproto3.Query{
					String: "DEALLOCATE PREPARE pstmt",
				},
	...
	tt := []MessageGroup{
		...
		/* by Execute(DEALLOCATE pstmt) */
		{
			Request: []pgproto3.FrontendMessage{
				&pgproto3.Parse{
					Name:  "remover",
					Query: "DEALLOCATE PREPARE pstmt",
				},
				&pgproto3.Parse{
					Name:  "pstmt",
					Query: "select 42",
...
func TestMultiShardUpdateCCXproto(t *testing.T) {
	...
	tt := []MessageGroup{
		{
			...
			Request: []pgproto3.FrontendMessage{
				...
				&pgproto3.Parse{
					Query: "UPDATE test_3col_table SET ff = 't1' WHERE j = $1",
				},
				&pgproto3.Bind{
					Parameters: [][]byte{
						[]byte("1"),
				...
				&pgproto3.Sync{},
				&pgproto3.Query{
					String: "UPDATE test_3col_table SET ff = 't1' WHERE j = 12",
				},
				&pgproto3.Query{
					String: "ROLLBACK",
				},
...
func TestPortalDescReuse(t *testing.T) {
	...
	tt := []MessageGroup{
...

		{
			...
			Request: []pgproto3.FrontendMessage{
				...
				&pgproto3.Parse{
					Query: "SELECT count(1) FROM t WHERE $1",
				},

				&pgproto3.Bind{
					Parameters: [][]byte{[]byte("true")},
				},
				&pgproto3.Describe{
					ObjectType: 'P',
				},
		...
		/* create named portal, describe, close, re-create, execute */
		{
			Request: []pgproto3.FrontendMessage{
				...
				&pgproto3.Bind{
					...
					ParameterFormatCodes: []int16{xproto.FormatCodeText, xproto.FormatCodeText, xproto.FormatCodeText},
				},
				&pgproto3.Describe{
					ObjectType: 'P',
					Name:       "",
				...
				&pgproto3.Bind{
					...
					ParameterFormatCodes: []int16{xproto.FormatCodeText, xproto.FormatCodeBinary, xproto.FormatCodeText},
				},
				&pgproto3.Execute{
					Portal: "",
				},
				...
				&pgproto3.Bind{
					...
					ParameterFormatCodes: []int16{xproto.FormatCodeText, xproto.FormatCodeBinary, xproto.FormatCodeBinary},
				},
				&pgproto3.Execute{
					Portal: "",
				},

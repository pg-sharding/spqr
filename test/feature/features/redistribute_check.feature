Feature: Redistribution test
  ...
  Scenario: REDISTRIBUTE KEY RANGE checks for non-deferrable constraints
    ...
    And command output should match regexp
    """
    found non-deferrable constraint or constraint referencing non-distributed table: "xmove2_skey_fkey"
    """
    ...
    And command output should match regexp
    """
    found non-deferrable constraint or constraint referencing non-distributed table: "xmove_pkey_fkey"
    """

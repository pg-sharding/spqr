Feature: Reference relation test
  Scenario: Basic ref relation DML
    ...
    INSERT INTO t VALUES(1, 'test1') /* __spqr__engine_v2: true */;
    INSERT INTO t VALUES(2, 'test2') /* __spqr__engine_v2: true */;
    INSERT INTO t VALUES(3, 'test3') /* __spqr__engine_v2: true */;
    """
    Then command return code should be "0"

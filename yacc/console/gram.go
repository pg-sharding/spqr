...
var yyAct = [...]uint8{
	...
	154, 133, 147, 118, 143, 93, 132, 27, 28, 163,
	157, 214, 215, 180, 181, 182, 98, 145, 124, 30,
	29, 34, 35, 70, 90, 21, 20, 24, 25, 26,
	31, 32, 52, 51, 82, 69, 36, 86, 220, 221,
	222, 88, 186, 140, 89, 83, 83, 150, 56, 96,
	97, 83, 83, 54, 83, 58, 122, 61, 108, 223,
	...
	85, 146, 216, 63, 207, 204, 119, 119, 116, 114,
	...
	209, 171, 83, 212, 71, 73, 72, 218, 172, 217,
	66, 224, 37, 1, 18, 71, 158, 227, 17, 16,
	15, 14, 12, 13, 228, 8, 229, 9, 213, 162,
	232, 227, 231, 233, 131, 115, 178, 142, 112, 79,
	19, 219, 149, 225, 6, 5, 4, 3, 7, 11,
...
var yyPact = [...]int16{
	...
	-1000, 135, 202, 15, 181, 191, 198, -59, 187, -1000,
	-1000, 158, 90, -52, -1000, -1000, 198, -18, 10, -1000,
	198, -1000, -1000, -1000, -1000, -1000, 198, -1000, -1000, -1000,
	-1000, -1000, -1000, 198, -12, 150, -1000, 63, -12, -1000,
	198, -1000, -1000, -1000,
}
...
var yyPgo = [...]int16{
	...
	227, 225, 223, 222, 221, 220, 219, 218, 214, 213,
	212,
}
...
var yyDef = [...]int16{
	...
	97, 0, 0, 0, 111, 0, 0, 73, 34, 32,
	33, 120, 0, 0, 86, 89, 0, 0, 0, 108,
	0, 114, 76, 74, 71, 72, 0, 83, 103, 101,
	98, 99, 100, 0, 104, 62, 60, 102, 104, 110,
	0, 61, 109, 59,
}
...
//line gram.y:591
		{
			yyVAL.group_by_clause = GroupBy{ColRef: yyDollar[3].colref}
		}
	case 77:
		yyDollar = yyS[yypt-0 : yypt+1]
//line gram.y:594
		{
			yyVAL.group_by_clause = GroupByEmpty{}
		}
	case 78:
		yyDollar = yyS[yypt-5 : yypt+1]
//line gram.y:598
		{
			yyVAL.show = &Show{Cmd: yyDollar[2].str, Where: yyDollar[3].where, Order: yyDollar[4].order_clause, GroupBy: yyDollar[5].group_by_clause}
		}
	case 79:
		yyDollar = yyS[yypt-2 : yypt+1]
//line gram.y:603

...
```sql
-- Create a replicated table on all shards
-- Note: __spqr__auto_distribution automatically adds the table to SPQR metadata
-- See Routing Hints documentation for more details

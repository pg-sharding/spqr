...
NOTICE: send query to shard(s) : sh1@spqr_shard_1:6432,sh2@spqr_shard_2:6432,sh3@spqr_shard_3:6432,sh4@spqr_shard_4:6432
...
NOTICE: send query to shard(s) : sh1@spqr_shard_1:6432
...
NOTICE: send query to shard(s) : sh2@spqr_shard_2:6432
 country_code | state_code | tax_rate | tax_category
--------------+------------+----------+--------------
 US           | CA         |   7.25   | Sales
 US           | NY         |   8.875  | Sales

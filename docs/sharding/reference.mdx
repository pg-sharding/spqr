...
Some common examples when to use reference tables:

- In eCommerce, sales tax rates apply to all stores.
- A table with country codes and region names.
- A list of product categories used by multiple stores.
- A system-wide list of roles and permissions.
- Exchange rates.
- Global settings or feature flags used by all users.
- In a SaaS platform, a table defining different subscription tiers, their pricing, and feature sets.

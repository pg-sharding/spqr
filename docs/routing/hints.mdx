...
For more details on transaction control, see [Distributed Transactions](/features/distributed_transactions).
...
**Warning:** Scatter queries do not provide consistent cross-shard snapshots and can have significant performance impact. Use primarily for administrative or analytical purposes.

For more details, see [Distributed Transactions](/features/distributed_transactions).
...
For comprehensive information about transaction strategies, including when to use each mode, see [Distributed Transactions](/features/distributed_transactions).

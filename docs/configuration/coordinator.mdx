...
| `auto_rebootstrap`        | Whether to check router's QDB contents and perform automatic re-bootstrapping. | `true`, `false` | `false` |
...
5. Sync router QDB metadata if enabled via `auto_rebootstrap`

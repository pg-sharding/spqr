...
| `display_greeting`         | Whether to display greeting message on client connection. Default: `false`                    | `true`, `false`                               |
...
| `etcd_max_txn_ops`         | Max subcommand count for complex commands in meta transactions. 128 is default value         | Any integer value between 0 and 65535 |

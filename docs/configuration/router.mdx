...
| `qdb_max_txn_ops`      | Max subcommandcount for complex commands in meta transactions. coordinator param `etcd_max_txn_ops` is stronger  | Any integer value between 0 and 65535 |

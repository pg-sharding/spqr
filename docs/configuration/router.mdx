...
| Setting                       | Description                                                                                                              | Possible Values                     |
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------|-------------------------------------|
| `distributed_commit_strategy` | Default commit strategy for distributed transactions. Can be overridden per session with `__spqr__commit_strategy`. See [Distributed Transactions](/features/distributed_transactions) for details. | `best-effort`, `1pc`, `2pc` |

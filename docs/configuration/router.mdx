...
| `query_routing.engine_default`                 | Sets the default routing engine version. When set to `v2`, enables `enhanced_multishard_processing`. Can be overridden by the [__spqr__engine_v2](/routing/hints#spqr-engine-v2) hint. | `v2`  | Yes |

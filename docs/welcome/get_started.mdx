...
```sql
CREATE KEY RANGES FOR DISTRIBUTION ds1 BETWEEN 0 AND 2000 USING SHARDS shard1, shard2;
```
<Warning>
...
demo=> BEGIN;
BEGIN
demo=> INSERT INTO orders (id, customer_id, order_date) VALUES (777, 123456, '2024-01-08');

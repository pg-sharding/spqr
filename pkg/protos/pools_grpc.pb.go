...
type PoolServiceClient interface {
	ListPools(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListPoolsResponse, error)
}
...
func (c *poolServiceClient) ListPools(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListPoolsResponse, error) {
...
type PoolServiceServer interface {
	ListPools(context.Context, *empty.Empty) (*ListPoolsResponse, error)
...
func (UnimplementedPoolServiceServer) ListPools(context.Context, *empty.Empty) (*ListPoolsResponse, error) {
...
func _PoolService_ListPools_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PoolServiceServer).ListPools(ctx, req.(*empty.Empty))
	}

...
type ClientInfoServiceClient interface {
	ListClients(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListClientsReply, error)
}
...
func (c *clientInfoServiceClient) ListClients(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListClientsReply, error) {
...
type ClientInfoServiceServer interface {
	ListClients(context.Context, *empty.Empty) (*ListClientsReply, error)
...
func (UnimplementedClientInfoServiceServer) ListClients(context.Context, *empty.Empty) (*ListClientsReply, error) {
...
func RegisterClientInfoServiceServer(s grpc.ServiceRegistrar, srv ClientInfoServiceServer) {
	// If the following call pancis, it indicates UnimplementedClientInfoServiceServer was
...
func _ClientInfoService_ListClients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientInfoServiceServer).ListClients(ctx, req.(*empty.Empty))
	}

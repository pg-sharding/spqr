...
func (UnimplementedBackendConnectionsServiceServer) ListBackendConnections(context.Context, *emptypb.Empty) (*ListBackendConnectionsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListBackendConnections not implemented")
}
...
func RegisterBackendConnectionsServiceServer(s grpc.ServiceRegistrar, srv BackendConnectionsServiceServer) {
	// If the following call panics, it indicates UnimplementedBackendConnectionsServiceServer was

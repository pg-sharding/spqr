...
type BackendConnectionsServiceClient interface {
	ListBackendConnections(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListBackendConnectionsReply, error)
}
...
func (c *backendConnectionsServiceClient) ListBackendConnections(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListBackendConnectionsReply, error) {
...
type BackendConnectionsServiceServer interface {
	ListBackendConnections(context.Context, *empty.Empty) (*ListBackendConnectionsReply, error)
...
func (UnimplementedBackendConnectionsServiceServer) ListBackendConnections(context.Context, *empty.Empty) (*ListBackendConnectionsReply, error) {
...
func _BackendConnectionsService_ListBackendConnections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendConnectionsServiceServer).ListBackendConnections(ctx, req.(*empty.Empty))
	}

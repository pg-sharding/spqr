...
type RouterServiceClient interface {
	ListRouters(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListRoutersReply, error)
	AddRouter(ctx context.Context, in *AddRouterRequest, opts ...grpc.CallOption) (*AddRouterReply, error)
	RemoveRouter(ctx context.Context, in *RemoveRouterRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	SyncMetadata(ctx context.Context, in *SyncMetadataRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *routerServiceClient) ListRouters(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListRoutersReply, error) {
...
func (c *routerServiceClient) RemoveRouter(ctx context.Context, in *RemoveRouterRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *routerServiceClient) SyncMetadata(ctx context.Context, in *SyncMetadataRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type RouterServiceServer interface {
	ListRouters(context.Context, *empty.Empty) (*ListRoutersReply, error)
	AddRouter(context.Context, *AddRouterRequest) (*AddRouterReply, error)
	RemoveRouter(context.Context, *RemoveRouterRequest) (*empty.Empty, error)
	SyncMetadata(context.Context, *SyncMetadataRequest) (*empty.Empty, error)
...
func (UnimplementedRouterServiceServer) ListRouters(context.Context, *empty.Empty) (*ListRoutersReply, error) {
...
func (UnimplementedRouterServiceServer) RemoveRouter(context.Context, *RemoveRouterRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveRouter not implemented")
}
func (UnimplementedRouterServiceServer) SyncMetadata(context.Context, *SyncMetadataRequest) (*empty.Empty, error) {
...
func _RouterService_ListRouters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouterServiceServer).ListRouters(ctx, req.(*empty.Empty))
	}

...
type ShardServiceClient interface {
	ListShards(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListShardsReply, error)
	AddDataShard(ctx context.Context, in *AddShardRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	AddWorldShard(ctx context.Context, in *AddWorldShardRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *shardServiceClient) ListShards(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListShardsReply, error) {
...
func (c *shardServiceClient) AddDataShard(ctx context.Context, in *AddShardRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *shardServiceClient) AddWorldShard(ctx context.Context, in *AddWorldShardRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type ShardServiceServer interface {
	ListShards(context.Context, *empty.Empty) (*ListShardsReply, error)
	AddDataShard(context.Context, *AddShardRequest) (*empty.Empty, error)
	AddWorldShard(context.Context, *AddWorldShardRequest) (*empty.Empty, error)
...
func (UnimplementedShardServiceServer) ListShards(context.Context, *empty.Empty) (*ListShardsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListShards not implemented")
}
func (UnimplementedShardServiceServer) AddDataShard(context.Context, *AddShardRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddDataShard not implemented")
}
func (UnimplementedShardServiceServer) AddWorldShard(context.Context, *AddWorldShardRequest) (*empty.Empty, error) {
...
func _ShardService_ListShards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShardServiceServer).ListShards(ctx, req.(*empty.Empty))
	}

...
type ShardServiceClient interface {
	ListShards(ctx context.Context, in *ListShardRequest, opts ...grpc.CallOption) (*ListShardReply, error)
...
func (c *shardServiceClient) ListShards(ctx context.Context, in *ListShardRequest, opts ...grpc.CallOption) (*ListShardReply, error) {
	out := new(ListShardReply)
...
type ShardServiceServer interface {
	ListShards(context.Context, *ListShardRequest) (*ListShardReply, error)
...
func (UnimplementedShardServiceServer) ListShards(context.Context, *ListShardRequest) (*ListShardReply, error) {
...
func _ShardService_ListShards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShardServiceServer).ListShards(ctx, req.(*ListShardRequest))
	}

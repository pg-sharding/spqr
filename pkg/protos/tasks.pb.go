...
const file_protos_tasks_proto_rawDesc = "" +
	"\n" +
	"\x12protos/tasks.proto\x12\x04spqr\x1a\x1bgoogle/protobuf/empty.proto\"r\n" +
	"\bMoveTask\x12&\n" +
	"\x0ekeyRangeIdTemp\x18\x01 \x01(\tR\x0ekeyRangeIdTemp\x12\x14\n" +
	"\x05bound\x18\x02 \x03(\fR\x05bound\x12(\n" +
	"\x06status\x18\x03 \x01(\x0e2\x10.spqr.TaskStatusR\x06status\"\xc4\x01\n" +
	"\rMoveTaskGroup\x12$\n" +
	"\x05tasks\x18\x01 \x03(\v2\x0e.spqr.MoveTaskR\x05tasks\x12#\n" +
	...
	"\fkeyRangeIdTo\x18\x06 \x01(\tR\fkeyRangeIdTo\"J\n" +
	...
	"\ttaskGroup\x18\x01 \x01(\v2\x13.spqr.MoveTaskGroupR\ttaskGroup\"\x90\x02\n" +
	"\fBalancerTask\x12\"\n" +
	...
	"\x15RedistributeTaskMoved\x10\x012\xf7\x01\n" +
	...
	"\x13RemoveMoveTaskGroup\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x002\xf5\x01\n" +

...
type TopologyServiceClient interface {
	OpenRouter(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error)
	GetRouterStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetRouterStatusReply, error)
	CloseRouter(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error)
	UpdateCoordinator(ctx context.Context, in *UpdateCoordinatorRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	GetCoordinator(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetCoordinatorResponse, error)
}
...
func (c *topologyServiceClient) OpenRouter(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (c *topologyServiceClient) GetRouterStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetRouterStatusReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *topologyServiceClient) CloseRouter(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *topologyServiceClient) UpdateCoordinator(ctx context.Context, in *UpdateCoordinatorRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *topologyServiceClient) GetCoordinator(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetCoordinatorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TopologyServiceServer interface {
	OpenRouter(context.Context, *empty.Empty) (*empty.Empty, error)
	GetRouterStatus(context.Context, *empty.Empty) (*GetRouterStatusReply, error)
	CloseRouter(context.Context, *empty.Empty) (*empty.Empty, error)
	UpdateCoordinator(context.Context, *UpdateCoordinatorRequest) (*empty.Empty, error)
	GetCoordinator(context.Context, *empty.Empty) (*GetCoordinatorResponse, error)
...
func (UnimplementedTopologyServiceServer) OpenRouter(context.Context, *empty.Empty) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OpenRouter not implemented")
}
func (UnimplementedTopologyServiceServer) GetRouterStatus(context.Context, *empty.Empty) (*GetRouterStatusReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRouterStatus not implemented")
}
func (UnimplementedTopologyServiceServer) CloseRouter(context.Context, *empty.Empty) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CloseRouter not implemented")
}
func (UnimplementedTopologyServiceServer) UpdateCoordinator(context.Context, *UpdateCoordinatorRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCoordinator not implemented")
}
func (UnimplementedTopologyServiceServer) GetCoordinator(context.Context, *empty.Empty) (*GetCoordinatorResponse, error) {
...
func _TopologyService_OpenRouter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyServiceServer).OpenRouter(ctx, req.(*empty.Empty))
	}
...
func _TopologyService_GetRouterStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyServiceServer).GetRouterStatus(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TopologyService_CloseRouter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyServiceServer).CloseRouter(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TopologyService_GetCoordinator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopologyServiceServer).GetCoordinator(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

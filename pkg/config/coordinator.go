...
type Coordinator struct {
	...
	AutoRebootstrap        bool          `json:"auto_rebootstrap" toml:"auto_rebootstrap" yaml:"auto_rebootstrap"`
...
func (c *Coordinator) ApplyDefaults() {
	...
	c.DataMoveAwaitPIDTimeout = time.Minute
	c.DataMoveOptimisticPIDAwait = true

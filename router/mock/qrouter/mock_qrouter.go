...
func (m *MockQueryRouter) DeparseKeyWithRangesInternal(ctx context.Context, evals []interface{}, krs []*kr.KeyRange, types []string) (*routingstate.DataShardRoute, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeparseKeyWithRangesInternal", ctx, evals, krs, types)
	ret0, _ := ret[0].(*routingstate.DataShardRoute)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockQueryRouterMockRecorder) DeparseKeyWithRangesInternal(ctx, evals, krs, types interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeparseKeyWithRangesInternal", reflect.TypeOf((*MockQueryRouter)(nil).DeparseKeyWithRangesInternal), ctx, evals, krs, types)
}

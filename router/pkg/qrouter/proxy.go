...
func (qr *ProxyQrouter) DropKeyRange(ctx context.Context, id string) error {
	...
	spqrlog.Logger.Printf(spqrlog.LOG, "proxy.go: dropping key range %s", id)
...
func (qr *ProxyQrouter) DropKeyRangeAll(ctx context.Context) error {
	...
	spqrlog.Logger.Printf(spqrlog.LOG, "proxy.go: dropping all key ranges")
...
func (qr *ProxyQrouter) DropShardingRuleAll(ctx context.Context) error {
	return qr.qdb.DropShardingRuleAll(ctx)
}
